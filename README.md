...
the submitted JS code are not preserved. To debug the code, which is generated by the sandbox, activate its debug mode as follows:
...
```
--- Running JS ---
var InterruptTest = Java.type('delight.nashornsandbox.internal.InterruptTest');var isInterrupted = InterruptTest.isInterrupted;var intCheckForInterruption1036972529 = function() {	if (isInterrupted()) {	    throw new Error('Interrupted1036972529')	}};var in_the_first_line_all_good;intCheckForInterruption1036972529();
var so_is_the_second;intCheckForInterruption1036972529();
var and_the_third;intCheckForInterruption1036972529();
blah_blah_blah();
--- JS END ---
```
